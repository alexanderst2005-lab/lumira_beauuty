...
export const products: Product[] = [
  ...
  // PESTAÑAS ENTERAS
  // ==========================================
  { id: 'pe-001', name: 'Pestañas enteras volumen', description: 'Pestañas completas con volumen intenso.', fullDescription: 'Pestañas completas con volumen intenso para una mirada impactante.', price: 25000, category: 'pestanas-enteras', image: '/images/products/pestanas-enteras-volumen.jpg' },
  { id: 'pe-002', name: 'Pestañas enteras ojo de gato', description: 'Diseño estilizado que crea un efecto de ojos más alargados.', fullDescription: 'Diseño estilizado que crea un efecto de ojos más alargados.', price: 25000, category: 'pestanas-enteras', image: '/images/products/pestanas-enteras-ojo-gato.jpg' },
  { id: 'pe-003', name: 'Pestañas enteras con color', description: 'Pestañas decorativas con color para un look diferente.', fullDescription: 'Pestañas decorativas con color para un look diferente y llamativo.', price: 25000, category: 'pestanas-enteras', image: '/images/products/pestanas-enteras-color.jpg' },
  ...
  // SKINCARE
  // ==========================================
  { id: 'sk-001', name: 'Jabón de Azufre Purpure', description: 'Limpia profundamente y controla el exceso de grasa.', fullDescription: 'Limpia profundamente la piel y ayuda a controlar el exceso de grasa.', price: 12000, category: 'skincare', image: '/images/products/jabon-azufre.png' },
  { id: 'sk-002', name: 'Colágeno de Ojeras Bioaqua', description: 'Hidrata y revitaliza el contorno de ojos.', fullDescription: 'Ayuda a hidratar y revitalizar el contorno de los ojos, reduciendo ojeras.', price: 1200, category: 'skincare', image: '/images/products/colageno-ojeras.jpg' },
  ...
  { id: 'sk-004', name: 'Sérum de Vitamina C 30ML', description: 'Ilumina la piel y unifica el tono.', fullDescription: 'Ilumina la piel y ayuda a unificar el tono del rostro.', price: 8000, category: 'skincare', image: '/images/products/serum-vitamina-c.png' },
  { id: 'sk-005', name: 'Protector Solar SPF50+ Bioaqua', description: 'Protección solar de amplio espectro.', fullDescription: 'Protección solar de amplio espectro para el uso diario sin residuo blanco.', price: 12000, category: 'skincare', image: '/images/products/protector-solar.png' },
  { id: 'sk-006', name: 'Mascarilla para Puntos Negros', description: 'Remueve impurezas y limpia poros.', fullDescription: 'Ayuda a remover impurezas profundas y a limpiar los poros del rostro.', price: 3000, category: 'skincare', image: '/images/products/mascarilla-puntos-negros.jpg' },
  { id: 'sk-007', name: 'Toallas Desmaquillantes', description: 'Eliminan maquillaje e impurezas rápidamente.', fullDescription: 'Eliminan maquillaje e impurezas de forma práctica y suave con la piel.', price: 7000, category: 'skincare', image: '/images/products/toallas-desmaquillantes.png' },
  { id: 'sk-008', name: 'Chapstick Hidratante Bioaqua', description: 'Mantiene los labios suaves e hidratados.', fullDescription: 'Mantiene los labios suaves, hidratados y protegidos durante todo el día.', price: 4000, category: 'skincare', image: '/images/products/chapstick-hidratante.jpg' },
  ...
  { id: 'sk-010', name: 'Bloom Aqua Tint', description: 'Tinta ligera hidratante de acabado natural.', fullDescription: 'Tinta de acabado ligero y base acuosa para un look natural.', price: 15000, category: 'skincare', image: '/images/products/bloom-aqua-tint.png' },
  { id: 'sk-011', name: 'Parches de Granitos', description: 'Protegen y secan imperfecciones.', fullDescription: 'Ayudan a proteger y tratar imperfecciones focalizadas durante la noche.', price: 5000, category: 'skincare', image: '/images/products/parches-granitos.png' },
  { id: 'sk-012', name: 'Bloom Lamination', description: 'Define y fija las cejas.', fullDescription: 'Producto especial para definir, laminar y fijar cejas o pestañas.', price: 18000, category: 'skincare', image: '/images/products/bloom-lamination.png' },
  ...
  { id: 'sk-029', name: 'Mascarillas en Velo Bioaqua', description: 'Spa facial en casa.', fullDescription: 'Diferentes mascarillas faciales de velo para brindar una hidratación intensa.', price: 2200, category: 'skincare', image: '/images/products/mascarillas-velo.jpg' },
  ...
  // CORPORAL
  // ==========================================
  { id: 'cp-001', name: 'Aceite Truly 50ml', description: 'Aceite corporal suave y luminoso.', fullDescription: 'Aceite corporal hidratante de lujo para dejar una piel tersa y luminosa.', price: 16000, category: 'corporal', image: '/images/products/aceite-truly.png' },
  { id: 'cp-002', name: 'Rayitos de Sol', description: 'Aporta un hermoso efecto bronceado.', fullDescription: 'Producto luminoso para aportar un efecto bronceado y brillante a la piel.', price: 15000, category: 'corporal', image: '/images/products/rayitos-sol.png' },
  { id: 'cp-003', name: 'Brilli Brilli Purpure', description: 'Iluminador corporal brillante.', fullDescription: 'Iluminador corporal con acabado brillante espectacular para resaltar tus curvas.', price: 17000, category: 'corporal', image: '/images/products/brilli-brilli.png' },
  ...
  // ACCESORIOS
  // ==========================================
  { id: 'ac-001', name: 'Perfiladores', description: 'Define cejas o vello facial.', fullDescription: 'Herramienta precisa y segura para definir cejas o remover el vello facial.', price: 3000, category: 'accesorios', image: '/images/products/perfiladores.jpg' },
  { id: 'ac-002', name: 'Salón Pro', description: 'Accesorio profesional de belleza.', fullDescription: 'Accesorio de belleza indispensable para facilitar la aplicación del maquillaje.', price: 8000, category: 'accesorios', image: '/images/products/salon-pro.png' },
  { id: 'ac-003', name: 'Cepillo más Brocha para Cejas', description: 'Doble punta para definir y peinar.', fullDescription: 'Brocha doble ideal para aplicar producto en las cejas y luego peinarlas.', price: 3000, category: 'accesorios', image: '/images/products/cepillo-brocha-cejas.png' },
