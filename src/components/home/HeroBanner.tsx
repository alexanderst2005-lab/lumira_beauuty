  ...
  return (
    <section className="relative overflow-hidden w-full" id="hero-banner">
      <div className="relative min-h-[500px] sm:min-h-[540px] md:min-h-[600px] lg:min-h-[640px] w-full">
        ...
        <button
          onClick={prev}
          className="absolute left-4 sm:left-6 top-1/2 -translate-y-1/2 p-3 rounded-full bg-white/70 backdrop-blur-sm hover:bg-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-20 border border-white/50"
          aria-label="Anterior"
        >
        ...
        <button
          onClick={next}
          className="absolute right-4 sm:right-6 top-1/2 -translate-y-1/2 p-3 rounded-full bg-white/70 backdrop-blur-sm hover:bg-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-20 border border-white/50"
          aria-label="Siguiente"
        >
          <ChevronRight className="w-5 h-5 text-txt" />
        </button>
