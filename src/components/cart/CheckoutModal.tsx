          ...
          >
            ...
            <div className="p-5 sm:p-6 border-t border-border bg-secondary-100/30">
              <button
                ...
                className={`w-full py-3.5 ${isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-green-500 hover:bg-green-600 active:scale-95 hover:scale-[1.02] shadow-lg shadow-green-500/25'} text-white font-semibold rounded-xl transition-all duration-300 transform flex items-center justify-center gap-2 text-base font-sans`}
              >
