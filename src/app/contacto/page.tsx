    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <motion.a
          ...
          className="group p-6 rounded-2xl bg-gradient-to-br from-green-50 to-green-100/50 border border-green-200/50 hover:shadow-xl hover:shadow-green-500/10 hover:-translate-y-1 transition-all duration-300"
        >
          <div className="w-12 h-12 rounded-xl bg-green-500 text-white flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            <MessageCircle className="w-6 h-6" />
          </div>
          <h3 className="font-heading font-semibold text-lg text-text mb-1">WhatsApp</h3>
          <p className="text-sm text-text-light">Escríbenos directamente por WhatsApp</p>
        </motion.a>
        ...
        <motion.a
          ...
          className="group p-6 rounded-2xl bg-gradient-to-br from-pink-50 to-purple-50 border border-pink-200/50 hover:shadow-xl hover:shadow-pink-500/10 hover:-translate-y-1 transition-all duration-300"
        >
          ...
          <p className="text-sm text-text-light">Síguenos para ver las novedades</p>
        </motion.a>
        ...
        <motion.a
          ...
          className="group p-6 rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100/50 border border-gray-200/50 hover:shadow-xl hover:shadow-gray-500/10 hover:-translate-y-1 transition-all duration-300"
        >
          ...
          <p className="text-sm text-text-light">Mira nuestros tutoriales y tips</p>
        </motion.a>
